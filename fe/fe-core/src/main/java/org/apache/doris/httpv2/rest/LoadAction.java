...
public class LoadAction extends RestBaseController {
    ...
    public Object streamLoad(HttpServletRequest request,
        ...
        try {
            ...
            boolean hasValidClusterToke = checkClusterToken(request);
            if (!hasValidClusterToke) {
    ...
    private boolean checkClusterToken(HttpServletRequest request) {
        ...
        LOG.info("Get token header: {}", request.getHeader("token"));
        LOG.info("Get column_separator header: {}", request.getHeader("column_separator"));
        return true;
    }
    ...
    private Object executeWithClusterToken(HttpServletRequest request,
        ...
        try {
            ...
            LOG.info("redirect load action with cluster token to destination={}," 
                        + "stream: {}, db: {}, tbl: {}, label: {}",
                    redirectAddr.toString(), isStreamLoad, dbName, tableName, label);
