...
public abstract class InternalDatabase extends Database {
    public static int COUNT = 0;

    public InternalDatabase(long id, String name) {
        super(id, name);
        initTables();
    }
    ...
    /**
     * InternalDatabase will not be persisted to bdb. It will be constructed everytime the fe starts.
    ...
    /**
     * InternalDatabase should not be read from bdb.
     */
    @Override
     ...
     * will call this method. And create view should not succeed under internal database.
     */
    @Override
