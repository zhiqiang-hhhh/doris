...
private:
    ...
    Status _ensure_inverted_index_loaded(std::shared_ptr<IndexFileReader> index_file_reader,
                                         const TabletIndex* index_meta) {
    ...
    [[nodiscard]] Status _load_inverted_index_index(
            std::shared_ptr<IndexFileReader> index_file_reader, const TabletIndex* index_meta);
