...
Status VectorizedFnCall::prepare_ann_range_search(const doris::VectorSearchUserParams& user_params,
...
Status VectorizedFnCall::evaluate_ann_range_search(
    ...
    RangeSearchParams params = range_search_runtime.to_range_search_params();

    params.roaring = &row_bitmap;
    DCHECK(params.roaring != nullptr);
    DCHECK(params.query_value != nullptr);
    RangeSearchResult result;
    auto stats = std::make_unique<AnnIndexStats>();
