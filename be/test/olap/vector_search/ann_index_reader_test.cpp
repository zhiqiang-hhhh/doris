...
TEST_F(VectorSearchTest, AnnIndexReaderRangeSearch) {
    ...
    for (size_t i = 0; i < iterato; ++i) {
        ...
        std::cout << "doris search result size: " << doris_search_result_order_by_lables.size()
                  << ", native search result size: "
                  << native_search_result_order_by_lables.size() << std::endl;
